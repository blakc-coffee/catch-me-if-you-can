...
import { getMissionState as getMissionStateHandler } from "./missionState.js";
...
export const getMissionState = callable("getMissionState", getMissionStateHandler, { maxInstances: 20 });
