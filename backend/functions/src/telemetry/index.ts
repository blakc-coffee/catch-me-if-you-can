...
export const updateTelemetry = callable("updateTelemetry", live.updateTelemetry, { maxInstances: 50, sensitive: true });
export const stopTracking = callable("stopTracking", live.stopTracking);
export const uploadLocationBatch = callable("uploadLocationBatch", batches.uploadLocationBatch, { maxInstances: 20, sensitive: true });
